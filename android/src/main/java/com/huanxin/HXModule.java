...
public class HXModule extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void SendText(String username,String content,Callback successCallback,Callback errorCallback){
        commonim = new Commonim(mReactContext);
        commonim.SendText(username, content, successCallback, errorCallback);
    }
    @ReactMethod
