...
public class Commonim {
    ...
    //发送文本消息及表情
    public void SendText(final String username, final String content,final Callback successCallback, final Callback errorCallback){
            ...
            public void onEvent(EMNotifierEvent event) {
                switch (event.getEvent()) {
                    case EventNewMessage: // 接收新消息
                    {
                        ...
                        sendRegisterEvent("NewMessage",message);
                        break;
                    }
